          ...
          return (
            <div className="w-full flex flex-col gap-2 items-center justify-center py-2">
              <button
                ...
                className="text-green-600 hover:text-green-900 underline font-semibold text-nowrap"
              >
                Completed
              </button>
              <button
                onClick={() => handleAction("cancelled", row.id)}
                className="text-red-600 hover:text-red-900 underline font-semibold text-nowrap"
              >
                Canceled
              </button>
            </div>
